...
<!-- Mirrored from uselooper.com/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 09:45:09 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"><!-- End Required meta tags -->
    <!-- Begin SEO tag -->
    <title> Basic Form | Looper - Bootstrap 4 Admin Theme </title>
          ...
          <div class="page has-sidebar has-sidebar-expand-xl">
              ...
              <div class="page-section">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          <label for="lbl1">Project name <abbr title="Required">*</abbr></label> <input type="text" class="form-control" id="lbl1" placeholder="Required asterisks" required="">
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="lbl2">Project name <span class="badge badge-danger">Required</span></label> <input type="text" class="form-control" id="lbl2" placeholder="Required label" required="">
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="lbl3">Description <span class="badge badge-secondary"><em>Optional</em></span></label>
                          <textarea class="form-control" id="lbl3" rows="3" placeholder="Optional label"></textarea>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label class="d-flex justify-content-between" for="lbl4"><span>Description</span> <span class="text-muted">0 of 80 characters used</span></label>
                ...
                <div id="floating-label" class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Floating label</legend> <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="email" class="form-control" id="fl1" value="johndoe@looper.com" placeholder="Email address" required=""> <label for="fl1">Email address</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            ...
                            </select> <label for="fls1">Country</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="password" class="form-control" id="fl2" placeholder="Password" required=""> <label for="fl2">Password</label>
                          </div>
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                    </form><!-- /.form -->
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="email" class="form-control" id="fl3" placeholder="Email address" disabled> <label for="fl3">Email address</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="email" class="form-control" id="fl4" value="readonly@looper.com" placeholder="Email address" readonly> <label for="fl4">Email address</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group has-spinner">
                            <span class="spinner-border spinner-border-sm text-primary show"></span> <input type="email" class="form-control" id="fl5" value="hasloading@looper.com" placeholder="Email address"> <label for="fl5">Email address</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="email" class="form-control is-valid" id="fl6" value="johndoe@looper.com" placeholder="Email address"> <label for="fl6">Email address</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <div class="form-label-group">
                            <input type="password" class="form-control is-invalid" id="fl7" value="secrettt" placeholder="Password"> <label for="fl7">Password</label>
                            <div class="invalid-feedback">
                ...
                <div id="selects" class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Selects</legend> <!-- grid row -->
                        <div class="row">
                          <!-- grid column -->
                          <div class="col-md-6">
                            <!-- .form-group -->
                            <div class="form-group">
                              <label for="sel1">Country</label> <select class="custom-select" id="sel1" required="">
                                <option value=""> Choose... </option>
                                <option> United States </option>
                              </select>
                            </div><!-- /.form-group -->
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="sel2">State</label> <select class="custom-select" id="sel2" required="">
                                <option value=""> Choose... </option>
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <legend>States</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label for="sel3">Country</label> <select class="custom-select" id="sel3" required="" disabled>
                            <option value=""> Choose... </option>
                        ...
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="sel4">Country</label> <select class="custom-select is-valid" id="sel4" required="">
                            <option value=""> Choose... </option>
                            <option selected> United States </option>
                          </select>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="sel5">State</label> <select class="custom-select is-invalid" id="sel5" required="">
                            <option value=""> Choose... </option>
                            <option> California </option>
                          </select>
                          <div class="invalid-feedback">
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <legend>Sizes</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label class="col-form-label col-form-label-sm" for="selSmall">Small select</label> <select class="custom-select custom-select-sm" id="selSmall">
                        ...
                        <!-- .form-group -->
                        <div class="form-group">
                          <label class="col-form-label col-form-label-lg" for="selLarge">Large select</label> <select class="custom-select custom-select-lg" id="selLarge">
                ...
                <div id="checkboxes" class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Checkboxes</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label class="d-block">Inline checkbox</label>
                          <div class="custom-control custom-control-inline custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ckb1"> <label class="custom-control-label" for="ckb1">Basic checkbox</label>
                          </div>
                          <div class="custom-control custom-control-inline custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ckb2" data-indeterminate="true"> <label class="custom-control-label" for="ckb2">Indeterminate</label>
                          </div>
                          <div class="custom-control custom-control-inline custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ckb3" checked> <label class="custom-control-label" for="ckb3">Checked</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          ...
                          <div class="custom-control-stacked">
                            <div class="custom-control custom-control-inline custom-control-nolabel custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="ckb4"> <label class="custom-control-label" for="ckb4">Basic checkbox</label>
                            </div>
                            <div class="custom-control custom-control-inline custom-control-nolabel custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="ckb5" data-indeterminate="true"> <label class="custom-control-label" for="ckb5">Indeterminate</label>
                            </div>
                            <div class="custom-control custom-control-inline custom-control-nolabel custom-checkbox">
                              <input type="checkbox" class="custom-control-input" id="ckb6" checked> <label class="custom-control-label" for="ckb6">Checked</label>
                            </div>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          ...
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ckb7"> <label class="custom-control-label" for="ckb7">Yes, this is a block checkbox</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          ...
                          <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" class="custom-control-input" id="ckb8"> <label class="custom-control-label" for="ckb8">Shipping address is the same as my billing address</label>
                            <div class="text-muted"> Reduces the number of fields required to check out. The billing address can still be edited. </div>
                          </div>
                          <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" class="custom-control-input" id="ckb9"> <label class="custom-control-label" for="ckb9">Save this information for next time</label>
                        ...
                        <div class="form-group">
                          <label>States</label>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="ckb10" disabled> <label class="custom-control-label" for="ckb10">Option is disabled</label>
                          </div>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input is-valid" id="ckb11"> <label class="custom-control-label" for="ckb11">Maximal project</label>
                          </div>
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input is-invalid" id="ckb12"> <label class="custom-control-label" for="ckb12">Autosave</label>
                            <div class="invalid-feedback">
                ...
                <div id="radios" class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Radios</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label class="d-block">Inline radio</label>
                          <div class="custom-control custom-control-inline custom-radio">
                            <input type="radio" class="custom-control-input" name="rdGroup1" id="rd1"> <label class="custom-control-label" for="rd1">Credit card</label>
                          </div>
                          <div class="custom-control custom-control-inline custom-radio">
                            <input type="radio" class="custom-control-input" name="rdGroup1" id="rd2"> <label class="custom-control-label" for="rd2">Debit card</label>
                          </div>
                          <div class="custom-control custom-control-inline custom-radio">
                            <input type="radio" class="custom-control-input" name="rdGroup1" id="rd3" checked> <label class="custom-control-label" for="rd3">Paypal</label>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="custom-control custom-radio mb-1">
                            <input type="radio" class="custom-control-input" name="rdGroup3" id="rd7"> <label class="custom-control-label" for="rd7">Credit card</label>
                            <div class="text-muted"> This is a help text to guide users to explain the choice you will be making. </div>
                          </div>
                          <div class="custom-control custom-radio mb-1">
                            <input type="radio" class="custom-control-input" name="rdGroup3" id="rd8" checked> <label class="custom-control-label" for="rd8">Paypal</label>
                            <div class="custom-control-hint mt-1">
                              <input type="text" class="form-control" placeholder="e.g. paypal@looper.com">
                            </div>
                          </div>
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label>States</label>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" name="rdGroup4" id="rd9" disabled> <label class="custom-control-label" for="rd9">Option is disabled</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input is-valid" name="rdGroup4" id="rd10"> <label class="custom-control-label" for="rd10">Maximal team</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input is-invalid" name="rdGroup4" id="rd11"> <label class="custom-control-label" for="rd11">Maximum project</label>
                            <div class="invalid-feedback">
                              <i class="fa fa-exclamation-circle fa-fw"></i> Can't update your setting, please try again. </div>
                          </div>
                        </div><!-- /.form-group -->
                ...
                <div id="switcher" class="card">
                  ...
                  <div class="list-group list-group-flush list-group-bordered">
                    ...
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Default</span> <!-- .switcher-control -->
                      <label class="switcher-control"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Disabled</span> <!-- .switcher-control -->
                      <label class="switcher-control"><input type="checkbox" class="switcher-input" checked disabled> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Success</span> <!-- .switcher-control -->
                      <label class="switcher-control switcher-control-success"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Danger</span> <!-- .switcher-control -->
                      <label class="switcher-control switcher-control-danger"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-header -->
                    <div class="list-group-header"> Switcher radio </div><!-- /.list-group-header -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Toggle radio #1</span> <!-- .switcher-control -->
                      <label class="switcher-control"><input type="radio" name="switchRadio" class="switcher-input"> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Toggle radio #2</span> <!-- .switcher-control -->
                      <label class="switcher-control"><input type="radio" name="switchRadio" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-header -->
                    <div class="list-group-header"> Sizing & labels </div><!-- /.list-group-header -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Large size</span> <!-- .switcher-control -->
                      <label class="switcher-control switcher-control-lg"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Label icon</span> <!-- .switcher-control -->
                      <label class="switcher-control"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on"><i class="fas fa-check"></i></span> <span class="switcher-label-off"><i class="fas fa-times"></i></span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      ...
                      <div>
                        <!-- .switcher-control -->
                        <label class="switcher-control switcher-control-success switcher-control-lg"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on"><i class="fas fa-check"></i></span> <span class="switcher-label-off"><i class="fas fa-times"></i></span></label> <!-- /.switcher-control -->
                        <!-- .switcher-control -->
                        <label class="switcher-control switcher-control-danger switcher-control-lg"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on"><i class="fas fa-lock"></i></span> <span class="switcher-label-off"><i class="fas fa-unlock"></i></span></label> <!-- /.switcher-control -->
                      </div>
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Label text</span> <!-- .switcher-control -->
                      <label class="switcher-control switcher-control-lg"><input type="checkbox" class="switcher-input" checked> <span class="switcher-indicator"></span> <span class="switcher-label-on">ON</span> <span class="switcher-label-off">OFF</span></label> <!-- /.switcher-control -->
                    </div><!-- /.list-group-item -->
                  </div><!-- /.list-group -->
                </div><!-- /.card -->
                <hr class="my-5">
                ...
                <div id="rating" class="card">
                  ...
                  <div class="list-group list-group-flush list-group-bordered">
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Default rating</span> <!-- .rating -->
                      <span class="rating"><input type="radio" name="rating1" id="ratingd5" value="5"> <label for="ratingd5"><span class="fa fa-star"></span></label> <input type="radio" name="rating1" id="ratingd4" value="4"> <label for="ratingd4"><span class="fa fa-star"></span></label> <input type="radio" name="rating1" id="ratingd3" value="3" checked> <label for="ratingd3"><span class="fa fa-star"></span></label> <input type="radio" name="rating1" id="ratingd2" value="2"> <label for="ratingd2"><span class="fa fa-star"></span></label> <input type="radio" name="rating1" id="ratingd1" value="1"> <label for="ratingd1"><span class="fa fa-star"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Readonly</span> <!-- .rating -->
                      <span class="rating has-readonly"><input type="radio" name="rating2" id="ratingr5" value="5" disabled> <label for="ratingr5"><span class="fa fa-star"></span></label> <input type="radio" name="rating2" id="ratingr4" value="4" disabled checked> <label for="ratingr4"><span class="fa fa-star"></span></label> <input type="radio" name="rating2" id="ratingr3" value="3" disabled> <label for="ratingr3"><span class="fa fa-star"></span></label> <input type="radio" name="rating2" id="ratingr2" value="2" disabled> <label for="ratingr2"><span class="fa fa-star"></span></label> <input type="radio" name="rating2" id="ratingr1" value="1" disabled> <label for="ratingr1"><span class="fa fa-star"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Use heart icon</span> <!-- .rating -->
                      <span class="rating rating-red"><input type="radio" name="rating3" id="ratingh3" value="3"> <label for="ratingh3"><span class="fa fa-heart"></span></label> <input type="radio" name="rating3" id="ratingh2" value="2" checked> <label for="ratingh2"><span class="fa fa-heart"></span></label> <input type="radio" name="rating3" id="ratingh1" value="1"> <label for="ratingh1"><span class="fa fa-heart"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Another icon</span> <!-- .rating -->
                      <span class="rating rating-teal"><input type="radio" name="rating4" id="ratingt3" value="3"> <label for="ratingt3"><span class="fa fa-trophy"></span></label> <input type="radio" name="rating4" id="ratingt2" value="2" checked> <label for="ratingt2"><span class="fa fa-trophy"></span></label> <input type="radio" name="rating4" id="ratingt1" value="1"> <label for="ratingt1"><span class="fa fa-trophy"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Toggleable single element</span> <!-- .rating -->
                      <span class="rating rating-indigo"><input type="checkbox" name="rating5" id="ratings1" value="1" checked> <label for="ratings1"><span class="fa fa-bookmark"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-header -->
                    <div class="list-group-header"> Sizes </div><!-- /.list-group-header -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Small</span> <!-- .rating -->
                      <span class="rating rating-sm"><input type="radio" name="rating6" id="ratingSm5" value="5"> <label for="ratingSm5"><span class="fa fa-star"></span></label> <input type="radio" name="rating6" id="ratingSm4" value="4"> <label for="ratingSm4"><span class="fa fa-star"></span></label> <input type="radio" name="rating6" id="ratingSm3" value="3" checked> <label for="ratingSm3"><span class="fa fa-star"></span></label> <input type="radio" name="rating6" id="ratingSm2" value="2"> <label for="ratingSm2"><span class="fa fa-star"></span></label> <input type="radio" name="rating6" id="ratingSm1" value="1"> <label for="ratingSm1"><span class="fa fa-star"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                    <!-- .list-group-item -->
                    <div class="list-group-item d-flex justify-content-between align-items-center">
                      <span>Large</span> <!-- .rating -->
                      <span class="rating rating-lg"><input type="radio" name="rating7" id="ratingLg5" value="5"> <label for="ratingLg5"><span class="fa fa-star"></span></label> <input type="radio" name="rating7" id="ratingLg4" value="4"> <label for="ratingLg4"><span class="fa fa-star"></span></label> <input type="radio" name="rating7" id="ratingLg3" value="3" checked> <label for="ratingLg3"><span class="fa fa-star"></span></label> <input type="radio" name="rating7" id="ratingLg2" value="2"> <label for="ratingLg2"><span class="fa fa-star"></span></label> <input type="radio" name="rating7" id="ratingLg1" value="1"> <label for="ratingLg1"><span class="fa fa-star"></span></label></span> <!-- /.rating -->
                    </div><!-- /.list-group-item -->
                  </div><!-- /.list-group -->
                </div><!-- /.card -->
                <hr class="my-5">
                ...
                <div class="section-block text-center text-sm-left">
                  ...
                  <div class="visual-picker has-peek">
                    ...
                    <label class="visual-picker-figure" for="vpc01">
                      ...
                      <span class="visual-picker-content"><span class="tile tile-lg bg-info"><i class="fa fa-credit-card"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                  ...
                  <div class="visual-picker has-peek">
                    <!-- visual-picker input -->
                    <input type="checkbox" id="vpc02" checked> <!-- .visual-picker-figure -->
                    <label class="visual-picker-figure" for="vpc02">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-lg bg-danger"><i class="fa fa-money-bill-alt"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                  ...
                  <div class="visual-picker has-peek">
                    <!-- visual-picker input -->
                    <input type="checkbox" id="vpc03"> <!-- .visual-picker-figure -->
                    <label class="visual-picker-figure" for="vpc03">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-lg bg-primary"><i class="fab fa-paypal"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                ...
                <!-- .section-block -->
                <div class="section-block">
                  <h3 class="section-title"> Fluid width </h3><!-- .visual-picker -->
                  <div class="visual-picker visual-picker-fluid" style="max-width: 392px;">
                    <!-- visual-picker input -->
                    <input type="checkbox" id="vpc04"> <!-- .visual-picker-figure -->
                    <label class="visual-picker-figure" for="vpc04">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-lg bg-success"><i class="oi oi-people"></i></span> <span class="d-block h5 mt-2">Teams</span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                  </div><!-- /.visual-picker -->
                </div><!-- /.section-block -->
                <!-- .section-block -->
                <div class="section-block text-center text-sm-left">
                  <h3 class="section-title"> Visual radio with small size </h3><!-- .visual-picker -->
                  ...
                  <div class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <label class="visual-picker-figure" for="vpr02">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-danger"><i class="fa fa-money-bill-alt"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                    <span class="visual-picker-peek">My Wallet</span>
                  </div><!-- /.visual-picker -->
                  <!-- .visual-picker -->
                  <div class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <label class="visual-picker-figure" for="vpr03">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-success"><i class="oi oi-people"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                  ...
                  <div class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <label class="visual-picker-figure" for="vpr04">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-warning"><i class="oi oi-question-mark"></i></span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                ...
                <!-- .section-block -->
                <div class="section-block text-center text-sm-left">
                  <h3 class="section-title pt-0"> Visual links </h3><!-- .visual-picker -->
                  <a href="#" class="visual-picker visual-picker-sm has-peek px-3">
                    <!-- .visual-picker-figure -->
                    <div class="visual-picker-figure">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-info"><i class="oi oi-person"></i></span></span> <!-- /.visual-picker-content -->
                  ...
                  <a href="#" class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <div class="visual-picker-figure">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-danger"><i class="fa fa-money-bill-alt"></i></span></span> <!-- /.visual-picker-content -->
                    </div><!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                    <span class="visual-picker-peek">My Wallet</span>
                  </a> <!-- /.visual-picker -->
                  ...
                  <a href="#" class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <div class="visual-picker-figure">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-success"><i class="oi oi-people"></i></span></span> <!-- /.visual-picker-content -->
                    </div><!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                    <span class="visual-picker-peek">Teams</span>
                  </a> <!-- /.visual-picker -->
                  ...
                  <a href="#" class="visual-picker visual-picker-sm has-peek px-3">
                    ...
                    <div class="visual-picker-figure">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="tile tile-sm bg-warning"><i class="oi oi-question-mark"></i></span></span> <!-- /.visual-picker-content -->
                    </div><!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                    <span class="visual-picker-peek">Help Center</span>
                  </a> <!-- /.visual-picker -->
                ...
                <!-- .section-block -->
                <div class="section-block text-center text-sm-left">
                  <h3 class="section-title"> Your plan </h3><!-- .visual-picker -->
                  <div class="visual-picker visual-picker-lg has-peek">
                    ...
                    <label class="visual-picker-figure" for="vpr05">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="h3 d-block">Free</span> <span>100GB Disk Space / 2GB Bandwidth</span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                  ...
                  <div class="visual-picker visual-picker-lg has-peek">
                    <!-- visual-picker input -->
                    <input type="radio" id="vpr07" name="vprLG" checked> <!-- .visual-picker-figure -->
                    <label class="visual-picker-figure" for="vpr07">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="h3 d-block">$49</span> <span>500GB Disk Space / 8GB Bandwidth</span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                  ...
                  <div class="visual-picker visual-picker-lg has-peek">
                    <!-- visual-picker input -->
                    <input type="radio" id="vpr08" name="vprLG"> <!-- .visual-picker-figure -->
                    <label class="visual-picker-figure" for="vpr08">
                      <!-- .visual-picker-content -->
                      <span class="visual-picker-content"><span class="h3 d-block">$99</span> <span>Unlimited Disk Space / Unlimited Bandwidth</span></span> <!-- /.visual-picker-content --></label> <!-- /.visual-picker-figure -->
                    <!-- .visual-picker-peek -->
                ...
                <div class="section-block">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <!-- .publisher -->
                      <div class="publisher">
                        <label for="publisherInput1" class="publisher-label">Write something</label> <!-- .publisher-input -->
                    ...
                    <div class="card-body">
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          <!-- .publisher -->
                          <div class="publisher">
                            <label for="publisherInput2" class="publisher-label">Reply to: Beni Arisandi</label> <!-- .publisher-input -->
                            <div class="publisher-input">
                            ...
                            <div class="publisher-actions">
                              ...
                              <div class="publisher-tools mr-auto">
                                <div class="btn btn-light btn-icon fileinput-button">
                                  <i class="fa fa-paperclip"></i> <input type="file" id="attachment2" name="attachment2[]" multiple>
                                </div><button type="button" class="btn btn-light btn-icon"><i class="far fa-smile"></i></button>
                              </div><!-- /.publisher-tools -->
                              <button type="submit" class="btn btn-primary">Publish</button>
                            </div><!-- /.publisher-actions -->
                    ...
                    <div class="card-body">
                      ...
                      <div class="publisher publisher-alt">
                        ...
                        <div class="publisher-actions">
                          ...
                          <div class="publisher-tools mr-auto">
                            <div class="btn btn-light btn-icon fileinput-button">
                              <i class="fa fa-paperclip"></i> <input type="file" id="attachment3" name="attachment3[]" multiple>
                            </div><button type="button" class="btn btn-light btn-icon"><i class="far fa-smile"></i></button>
                          </div><!-- /.publisher-tools -->
                          <button type="submit" class="btn btn-primary">Publish</button>
                        </div><!-- /.publisher-actions -->
                        ...
                        <div class="media-body">
                          ...
                          <div class="publisher publisher-alt">
                            ...
                            <div class="publisher-actions">
                              ...
                              <div class="publisher-tools mr-auto">
                                <div class="btn btn-light btn-icon fileinput-button">
                                  <i class="fa fa-paperclip"></i> <input type="file" id="attachment4" name="attachment4[]" multiple>
                                </div><button type="button" class="btn btn-light btn-icon"><i class="far fa-smile"></i></button>
                              </div><!-- /.publisher-tools -->
                              <button type="submit" class="btn btn-primary">Publish</button>
                            </div><!-- /.publisher-actions -->
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="media">
                        <figure class="user-avatar user-avatar-md mr-2">
                          <img src="assets/images/avatars/uifaces9.jpg" alt="">
                        </figure><!-- .media-body -->
                        <div class="media-body">
                          <!-- .publisher -->
                ...
                <div id="input-group" class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Prepended inputs</legend> <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi1">Prepended icon</label> <!-- .input-group -->
                          <div class="input-group">
                            <label class="input-group-prepend" for="pi1"><span class="input-group-text"><span class="far fa-building"></span></span></label> <input type="text" class="form-control" id="pi1" placeholder="e.g developer-team">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi2">Prepended icon w/ clearable</label> <!-- .input-group -->
                          <div class="input-group has-clearable">
                            <button type="button" class="close" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button> <label class="input-group-prepend" for="pi2"><span class="input-group-text"><span class="oi oi-magnifying-glass"></span></span></label> <input type="text" class="form-control" id="pi2" placeholder="Type something..." value="Moonlight">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                    </form><!-- /.form -->
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi3">Prepended text</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <div class="input-group-prepend">
                              <span class="input-group-text">http://</span>
                            </div><input type="text" class="form-control" id="pi3" placeholder="uselooper.com">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi4">Prepended label</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <label class="input-group-prepend" for="pi4"><span class="input-group-text">Email address:</span></label> <input type="email" class="form-control" id="pi4" placeholder="johndoe@looper.com">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                    </form><!-- /.form -->
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi5">Prepended select</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <div class="input-group-prepend">
                            ...
                            </div><input type="text" class="form-control" id="pi5" placeholder="(201) 555-0123">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi6">Prepended select & icon</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <!-- .input-group-prepend -->
                            <div class="input-group-prepend">
                              <select class="custom-select">
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><span class="oi oi-magnifying-glass"></span></span>
                              </div><input type="text" class="form-control" id="pi6" placeholder="Search record">
                            </div><!-- /.input-group -->
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi7">Prepended button</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <div class="input-group-prepend">
                              <button class="btn btn-secondary" type="button">Look Up</button>
                            </div><input type="text" class="form-control" id="pi7">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi8">Prepended button & icon</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <div class="input-group-prepend dropdown">
                              <button class="btn btn-secondary" type="button" data-toggle="dropdown">Filter by <span class="caret"></span></button>
                              <div class="dropdown-arrow"></div>
                              <div class="dropdown-menu">
                                <a href="#" class="dropdown-item">Price</a> <a href="#" class="dropdown-item">Trending</a> <a href="#" class="dropdown-item">Orders</a> <a href="#" class="dropdown-item">Likes</a>
                              </div>
                            </div><!-- .input-group -->
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><span class="oi oi-magnifying-glass"></span></span>
                              </div><input type="text" class="form-control" id="pi8" placeholder="Search">
                            </div><!-- /.input-group -->
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                  ...
                  <div class="card-body border-top">
                    ...
                    <form>
                      ...
                      <fieldset>
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi9">Prepended badge</label> <!-- .input-group -->
                          <div class="input-group">
                            <label class="input-group-prepend" for="pi9"><span class="badge">$</span></label> <input type="text" class="form-control" id="pi9">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="pi10">Prepended multiple badge</label> <!-- .input-group -->
                          <div class="input-group">
                            <label class="input-group-prepend" for="pi10"><span class="badge">apple <a href="#" data-dismiss="badge">×</a></span> <span class="badge">banana <a href="#">×</a></span></label> <input type="text" class="form-control" id="pi10">
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                    </form><!-- /.form -->
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      ...
                      <fieldset>
                        ...
                        <p class="text-muted"> Can do what prepended inputs does. </p><!-- .form-group -->
                        <div class="form-group">
                          <label for="ai1">Appended icon w/ validation</label> <!-- .input-group -->
                          <div class="input-group has-clearable is-valid">
                            <button type="button" class="close" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times-circle"></i></span></button> <input type="text" class="form-control" id="ai1" placeholder="e.g developer-team"> <label class="input-group-append" for="ai1"><span class="input-group-text"><span class="far fa-building"></span></span></label>
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="ai2">Appended spinner</label> <!-- .input-group -->
                          <div class="input-group has-spinner">
                            <div class="spinner-border spinner-border-sm text-primary show" role="status">
                              <span class="sr-only">Loading...</span>
                            </div><input type="text" class="form-control" id="ai2" placeholder="e.g developer-team">
                            <div class="input-group-append">
                              <span class="input-group-text"><span class="far fa-building"></span></span>
                            </div>
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                        <!-- .form-group -->
                        <div class="form-group">
                          <label for="ai3">Appended text</label> <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <input type="text" class="form-control" id="ai3" placeholder="Subscription fee">
                            <div class="input-group-append">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                      <!-- .fieldset -->
                      <fieldset>
                        <legend>Both inputs</legend> <!-- .form-group -->
                        <div class="form-group">
                          <!-- .input-group -->
                          <div class="input-group">
                            <label class="input-group-prepend" for="bi1"><span class="input-group-text">http://</span></label> <input type="text" class="form-control" id="bi1" placeholder="e.g. uselooper">
                            <div class="input-group-append">
                        ...
                        <div class="form-group">
                          <!-- .input-group -->
                          <div class="input-group input-group-alt">
                            <label class="input-group-prepend" for="bi2"><span class="input-group-text">http://</span></label> <input type="text" class="form-control" id="bi2" placeholder="e.g. uselooper">
                            <div class="input-group-append">
                              <span class="input-group-text">@domain.com</span>
                            </div>
                          </div><!-- /.input-group -->
                        ...
                        <div class="form-group">
                          <!-- .input-group -->
                          <div class="input-group">
                            <label class="input-group-prepend" for="bi3"><span class="badge">$</span></label> <input type="number" class="form-control" id="bi3" placeholder="Amount (to the nearest dollar)"> <label class="input-group-append"><span class="badge">.00</span></label>
                          </div><!-- /.input-group -->
                        </div><!-- /.form-group -->
                      </fieldset><!-- /.fieldset -->
                    </form><!-- /.form -->
                ...
                <div class="card">
                  <!-- .card-body -->
                  <div class="card-body">
                    <h4 class="card-title"> Billing address </h4><!-- form .needs-validation -->
                    <form class="needs-validation" novalidate="">
                      <!-- .form-row -->
                      <div class="form-row">
                        <!-- grid column -->
                        <div class="col-md-6 mb-3">
                          <label for="firstName">First name</label> <input type="text" class="form-control" id="firstName" required="">
                          <div class="invalid-feedback"> Valid first name is required. </div>
                        </div><!-- /grid column -->
                        <!-- grid column -->
                        <div class="col-md-6 mb-3">
                          <label for="lastName">Last name</label> <input type="text" class="form-control" id="lastName" required="">
                          <div class="invalid-feedback"> Valid last name is required. </div>
                        </div><!-- /grid column -->
                      </div><!-- /.form-row -->
                      <!-- .form-group -->
                      <div class="form-group">
                        <label for="username">Username</label> <input type="text" class="form-control" id="username" placeholder="Username" required="">
                        <div class="invalid-feedback"> Your username is required. </div>
                      </div><!-- /.form-group -->
                      <!-- .form-group -->
                      <div class="form-group">
                        <label for="email">Email <span class="badge badge-secondary"><em>Optional</em></span></label> <input type="email" class="form-control" id="email" placeholder="you@example.com">
                      ...
                      <!-- .form-group -->
                      <div class="form-group">
                        <label for="address2">Address 2 <span class="badge badge-secondary"><em>Optional</em></span></label> <input type="text" class="form-control" id="address2" placeholder="Apartment or suite">
                      </div><!-- /.form-group -->
                      <!-- .form-row -->
                      <div class="form-row">
                        <!-- grid column -->
                        ...
                        <div class="col-md-3 mb-3">
                          <label for="zip">Zip</label> <input type="text" class="form-control" id="zip" required="">
                      ...
                      <hr class="mb-4">
                      <h4 class="card-title"> Payment </h4><!-- .form-group -->
                      <div class="form-group">
                        <div class="custom-control custom-radio">
            ...
            <div class="page-sidebar page-sidebar-fixed">
              ...
              <nav id="nav-content" class="nav flex-column mt-4">
                <a href="#base-style" class="nav-link smooth-scroll">Base style</a> <a href="#labels" class="nav-link smooth-scroll">Labels</a> <a href="#floating-label" class="nav-link smooth-scroll">Floating label</a> <a href="#selects" class="nav-link smooth-scroll">Selects</a> <a href="#checkboxes" class="nav-link smooth-scroll">Checkboxes</a> <a href="#radios" class="nav-link smooth-scroll">Radios</a> <a href="#switcher" class="nav-link smooth-scroll">Switcher</a> <a href="#rating" class="nav-link smooth-scroll">Rating</a> <a href="#visual-picker" class="nav-link smooth-scroll">Visual picker</a> <a href="#publisher" class="nav-link smooth-scroll">Publisher</a> <a href="#input-group" class="nav-link smooth-scroll">Input group</a> <a href="#validation-states" class="nav-link smooth-scroll">Validation states</a>
              </nav><!-- /.nav -->
            </div><!-- /.page-sidebar -->
          </div><!-- /.page -->
        </div><!-- /.wrapper -->
...
<!-- Mirrored from uselooper.com/form-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2019 09:45:10 GMT -->
</html>