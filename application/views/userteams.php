            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <!-- .menu-item -->
                 ...
                 <li class="menu-item ">
                  <a href="<?php echo site_url('dashboard/userteams')?>" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text" style="color: #000">My Team</span> <span class="badge badge-subtle badge-success"></span></a> <!-- child menu -->  
                </li><!-- /.menu-item -->
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3" style="background: #fff">
                    <div class="card-header" style="color: #000"> My Team </div><!-- .lits-group -->
