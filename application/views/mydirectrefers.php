            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
               ...
               <li class="menu-item  has-child">
                ...
                <li class="menu-item">
                  <a href="<?php echo site_url('dashboard/mydirectrefers')?>" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text" style="color: #000">My Direct Refers</span> <span class="badge badge-subtle badge-success"></span></a> <!-- child menu -->  
                </li><!-- /.menu-item -->
            ...
            <!-- .page-cover -->
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  <!-- .card -->
                  <div class="card card-fluid pb-3" style="background: #fff;color: #000">
                    <div class="card-header"> My Direct Refers </div><!-- .lits-group -->
                    ...
                    <div class="tab-pane fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                      ...
                      <table id="orders-table" class="table table-striped table-bordered" style="width:100%;color: #000;">
                                <thead>
                                    <tr >
                                        <td>Name</td>
                                        <td>Username</td>
                            ...
                            <?php } else { ?>
                             <div class="card-header"> Direct Refers Not There</div>
                            <?php } ?>
                    </div>
