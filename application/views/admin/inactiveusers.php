...
<script type="text/javascript">
  $(document).ready(function() {
    $('#paymentReceipt').magnificPopup({type:'image'});
  });

  function ApproveDelear(user_id)
  {
    //alert('hi');
    //alert(user_id);
    ...
    $.ajax({
        type : "POST",
        url  : "<?php echo site_url('admin/activatedealer')?>",
        data : {
         user_id : user_id
        },
        dataType:"JSON",
       success : function(response){
         //alert(response);
         if(response){
            alert('Activated dealer successfully.');
         }         
       },
      error : function(e){
        console.log(e);
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-child">
                 ...
                 <li class="menu-item has-child">
                  <a href="<?php echo site_url('admin/inactiveusers')?>" class="menu-link"><span class="menu-icon oi oi-person"></span> <span class="activemenu">InActive Users</span> <span class="badge badge-subtle badge-success"></span></a> <!-- child menu -->  
                </li><!-- /.menu-item -->
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3">
                    <div class="card-header"> InActive Users </div><!-- .lits-group -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <?php if ($userdata->paymentReceipt != '') { ?>
                                           <a href="<?php echo base_url();?><?php echo $userdata->paymentReceipt?>"  target="popup"  onclick="window.open('<?php echo base_url();?><?php echo $userdata->paymentReceipt?>','popup','scrollbars=no,resizable=no'); return false;">

                                          <img src="<?php echo base_url();?>\<?php echo $userdata->paymentReceipt?>" id="paymentReceipt" width="100" height="100" />
                                        </a>
                                          <?php } else { ?>
                                            N/A
                                          <?php } ?>
                                        ...
                                        <td><input type="button" style="background: #346cb0;color: #fff;border-radius: 5px" name="approve" value="Approve" onclick="ApproveDelear(<?php echo $userdata->user_id;?>)"></td>
                                    </td>
                                    <?php }?>
                                </tbody>
                            </table>
