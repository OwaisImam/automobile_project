              ...
              <header class="page-title-bar">
                <div class="d-flex flex-column flex-md-row">
                  <p class="lead">
                    ...
                    <span class="font-weight-bold">Hi, <?php echo $this->session->user_name; ?>.</span> <span class="d-block text-muted">Here’s what’s happening with your business today.</span>
                  <?php } ?>
                  </p>
                  <div class="ml-auto">
                    <!-- .dropdown -->
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-md stop-propagation">
                        ...
                        <!-- .custom-control -->
                        <div class="custom-control custom-radio">
                          <input type="radio" class="custom-control-input" id="dpWeek" name="dpFilter" value="2" checked> <label class="custom-control-label d-flex justify-content-between" for="dpWeek"><span>This Week</span> <span class="text-muted">Mar 21-27</span></label>
                        </div><!-- /.custom-control -->
                        <!-- .custom-control -->
                        <div class="custom-control custom-radio">
                          <input type="radio" class="custom-control-input" id="dpMonth" name="dpFilter" value="3"> <label class="custom-control-label d-flex justify-content-between" for="dpMonth"><span>This Month</span> <span class="text-muted">Mar 1-31</span></label>
                        </div><!-- /.custom-control -->
                        <!-- .custom-control -->
                        <div class="custom-control custom-radio">
                        ...
                        <div class="custom-control custom-radio">
                          ...
                          <div class="custom-control-hint my-1">
                            <!-- datepicker:range -->
                            <input type="text" class="form-control" data-toggle="flatpickr" data-mode="range" data-disable-mobile="true" data-date-format="Y-m-d"> <!-- /datepicker:range -->
                          </div>
                        </div><!-- /.custom-control -->
                      </div><!-- /.dropdown-menu -->
                    </div><!-- /.dropdown -->
                      ...
                      <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item">
                          ...
                          <div class="list-group-item-figure">
                            <a href="<?php echo site_url('dashboard/userprofile')?>" class="user-avatar" data-toggle="tooltip" title="Martha Myers"><img src="<?php echo base_url();?>assets/images/avatars/uifaces16.jpg" alt=""></a>
                        ...
                        <div class="list-group-item">
                          <!-- .list-group-item-figure -->
                          <div class="list-group-item-figure">
                            <a href="<?php echo site_url('dashboard/userprofile')?>" class="user-avatar" data-toggle="tooltip" title="Tammy Beck"><img src="<?php echo base_url();?>assets/images/avatars/uifaces15.jpg" alt=""></a>
                          </div><!-- /.list-group-item-figure -->
                          <!-- .list-group-item-body -->
                          <div class="list-group-item-body">
                            <!-- .progress -->
                        ...
                        <div class="list-group-item">
                          <!-- .list-group-item-figure -->
                          <div class="list-group-item-figure">
                            <a href="<?php echo site_url('dashboard/userprofile')?>" class="user-avatar" data-toggle="tooltip" title="Susan Kelley"><img src="<?php echo base_url();?>assets/images/avatars/uifaces17.jpg" alt=""></a>
                          </div><!-- /.list-group-item-figure -->
                          <!-- .list-group-item-body -->
                          <div class="list-group-item-body">
                            <!-- .progress -->
                        ...
                        <div class="list-group-item">
                          <!-- .list-group-item-figure -->
                          <div class="list-group-item-figure">
                            <a href="<?php echo site_url('dashboard/userprofile')?>" class="user-avatar" data-toggle="tooltip" title="Albert Newman"><img src="<?php echo base_url();?>assets/images/avatars/uifaces18.jpg" alt=""></a>
                          </div><!-- /.list-group-item-figure -->
                          <!-- .list-group-item-body -->
                          <div class="list-group-item-body">
                            <!-- .progress -->
                        ...
                        <div class="list-group-item">
                          <!-- .list-group-item-figure -->
                          <div class="list-group-item-figure">
                            <a href="<?php echo site_url('dashboard/userprofile')?>" class="user-avatar" data-toggle="tooltip" title="Kyle Grant"><img src="<?php echo base_url();?>assets/images/avatars/uifaces19.jpg" alt=""></a>
                          </div><!-- /.list-group-item-figure -->
                          <!-- .list-group-item-body -->
                          <div class="list-group-item-body">
                            <!-- .progress -->
