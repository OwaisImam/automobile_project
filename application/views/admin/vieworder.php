              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3">
                    <div class="card-header"> View Order Details </div><!-- .lits-group -->
                                ...
                                <?php foreach($orders  as $orderData){?>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                          <label>Name : </label>
                                          <label> <?php echo $orderData->orderShipName;?></label>
                                            
                                         </div>

                                         <div class="form-group col-md-6">
                                          <label>Email : </label>
                                            <label> <?php echo $orderData->orderEmail;?></label>
                                         </div>

                                         <div class="form-group col-md-6">
                                          <label>Mobile No : </label>
                                           <label> <?php echo $orderData->orderPhone;?></label>
                                            
                                         </div>
                                        
                                         <div class="form-group col-md-6">
                                          <label>Address Line1 : </label>
                                          <label> <?php echo $orderData->orderShipAddress;?></label>
                                            
                                        </div>

                                        <div class="form-group col-md-6">
                                          <label>Address Line2 : </label>
                                          <label> <?php echo $orderData->orderShipAddress2;?></label>
                                            
                                        </div>
                                        <div class="form-group col-md-6">
                                          <label>City : </label>
                                          <label> <?php echo $orderData->orderCity;?></label>
                                        </div>
                                        <div class="form-group col-md-6">
                                          <label>State : </label>
                                          <label> <?php echo $orderData->orderState;?></label>
                                        </div>
                                        <div class="form-group col-md-6">
                                          <label>Pincode : </label>
                                          <label> <?php echo $orderData->orderZip;?></label>
                                        </div>
                                    </div>
                                <?php }?>
                            </div>
