            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <!-- .menu-item -->
                 ...
                 <li class="menu-item has-child">
                  <a href="<?php echo site_url('admin/activeusers')?>" class="menu-link"><span class="menu-icon oi oi-person"></span> <span class="activemenu">Active Users</span> <span class="badge badge-subtle badge-success"></span></a> <!-- child menu -->  
                </li><!-- /.menu-item -->
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3">
                    <div class="card-header"> Active Users </div><!-- .lits-group -->
                    ...
                    <div class="tab-pane fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                      ...
                      <table id="orders-table" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <a href=""><tr>
                                        ...
                                        <td >
                                            ...
                                            <?php if($userdata->paymentReceipt) { ?>
                                              ...
                                              <img src="<?php echo base_url();?><?php echo $userdata->paymentReceipt?>" width="100" height="100" />
                                            <?php } else { echo 'N/A'; }  ?>
                                          </a>
                                      </td>
                            ...
                            <?php } else { ?>
                             <div class="card-header"> No Active Users </div>
                            <?php } ?>
                    </div>
