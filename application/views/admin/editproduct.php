          ...
          <div class="aside-menu overflow-hidden">
            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
                ...
                <li class="menu-item has-child">
                  <a href="<?php echo site_url('admin/adminusers')?>" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text">Acive Users</span> <span class="badge badge-subtle badge-success"></span></a>
                </li>

                <li class="menu-item has-child">
                  <a href="<?php echo site_url('admin/adminusers')?>" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text">Inactive Users</span> <span class="badge badge-subtle badge-success"></span></a>
                </li>
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3">
                    <div class="card-header"> Edit Product </div><!-- .lits-group -->
                    <div class="lits-group list-group-flush">
                      <div class="card-body">
                       <input type="hidden" name="productId" value="<?php echo $productData->productId;?>">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                          <label>Name <span class="required">*</span></label>
                                            <input required="" class="form-control" name="productName" type="text" value="<?php echo $productData->productName;?>">
                                         </div>
                                         <div class="form-group col-md-6">
                                          <label>SKU </label>
                                            <input required="" class="form-control" id="productSKU" name="productSKU" type="text" value="<?php echo $productData->productSKU;?>" disabled>
                                         </div>
                                        
                                         <div class="form-group col-md-6">
                                          <label>Product Price (MRP) <span class="required">*</span></label>
                                            <input required="" class="form-control" name="productPrice" value="<?php echo $productData->productPrice;?>">
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label>Product Sell Price<span class="required">*</span></label>
                                            <input required="" class="form-control" name="productSellPrice" type="text" value="<?php echo $productData->productSellPrice;?>">
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label>Short Description <span class="required">*</span></label>
                                            <input required="" class="form-control" name="productShortDesc" type="text" value="<?php echo $productData->productShortDesc;?>">
                                        </div>
                                        <div class="form-group col-md-12">
                                          <label>Description <span class="required">*</span></label>
                                            <textarea name="productDesc" class="form-control" ><?php echo $productData->productDesc;?>
                                              </textarea>
                                        </div>
                                         <div class="form-group col-md-6">
                                          <label>Active Product </label>
                                          <?php if($productData->productAvailability == 'true') { ?>
                                          ...
                                          <label>Images </label>
                                            ...
                                            <?php 
                                              ...
                                              foreach ($images as $image) { //echo $image; ?>
                                                <img src="<?php echo base_url();?>\<?php echo $image?>" width="100" height="100" />
                                             <?php }?>
                                        </div>
                                ...
                                if ($productSaved) {
                                    echo 'The product details were successfully updated.';
                                }
