                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    <div class="mini-stat-icon float-right">
                                        <i class="fas fa-rupee-sign bg-success  text-white"></i>
                                    </div>
                                    <div>
                                        <h5 class="font-16">Revenue</h5>
                                    </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    ...
                                    <div>
                                        <h5 class="font-16">Site Visitors</h5>
                                    </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-heading p-4">
                                    <div class="mini-stat-icon float-right">
                                        <i class="fas fa-shopping-cart bg-danger text-white"></i>
                                    </div>
                                    <div>
                                        <h5 class="font-16">Orders</h5>
                                    </div>
                                    <h3 class="mt-4">86%</h3>
                                    <div class="progress mt-4" style="height: 4px;">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo" style="background-color: #8da9db;">
                                ...
                                <div class="list-content promo">
                                    <div class="promo-data">
                                        <ul>
                                            <li>
                                                <span class="title">sample text:</span><span class="value">000</span>
                                            </li>
                                            <li>
                                                <span class="title">sample text:</span><span class="value">000</span>
                                            </li>
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo" style="background-color: #e10f96;">
                                <div class="list-img promo">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo" style="background-color: #ffd966;">
                                <div class="list-img promo">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo" style="background-color: #02c58d;">
                                <div class="list-img promo">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo"; style="background-color: #f4b081;">
                                <div class="list-img promo">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="list-box promo" style="background-color: #757070;">
                                <div class="list-img promo">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">Details</h4>
