                                    ...
                                    <div class="card-body">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" placeholder="" name="contact">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" placeholder="" name="profession">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tr>
                                                    <th scope="row">1</th>
                                                    <td>Mark</td>
                                                    <td class="product-logo"><img src="<?php echo base_url();?>assets\images\dealer\users\user-4.jpg"></td>
                                                    <td>9456985960</td>
                                                    <td>Location1</td>
                                                    <td>Profession</td>
                                                    <td>Description</td>
