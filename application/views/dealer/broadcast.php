                    ...
                    <div class="container-fluid">
                         <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="mt-0 header-title">Broadcast</h4>
				...
				<div class="row">
                            <div class="col-md-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <form>
											<p>Add details for sending Messages through SMS</p>
							...
							<div class="col-md-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <form>
											<p>Add details for sending Messages through Whatsapp</p>
                                            <div class="form-group">
                                                <label>Schedule Time</label>
                                            <div >
                                                <input class="form-control" type="datetime-local" value="2011-08-19T13:45:00" id="example-datetime-local-input">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" required placeholder=""/>
                                            </div>
							...
							<div class="col-md-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <form>
											<p>Add Excel for sending Messages</p>
                                            <div class="form-group">
                                                <label>Schedule Time</label>
                                            <div >
                                                <input class="form-control" type="datetime-local" value="2011-08-19T13:45:00" id="example-datetime-local-input">
