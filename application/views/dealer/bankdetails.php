            ...
            <div class="content">
				...
				<div class="col-lg-6">
                                <div class="card m-b-30">
                                    ...
                                    <form class="" method="post" action="<?php echo site_url('dealer/bankdetails')?>">
										
										<div class="form-group">
                                                <label>Account Holder Name</label>
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control"  id="accountholder_name" name="accountholder_name" required
                                                           placeholder=""/>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                                <label>Confirm Bank A/c Number</label>
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="confirmaccount_no" name="confirmaccount_no"
                                                           placeholder=""/>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="ifsc_code" name="ifsc_code"
                                                           placeholder=""/>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="paytm_no" name="paytm_no"
                                                           placeholder=""/>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="gpay_no" name="gpay_no"
                                                           placeholder=""/>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="phonepe_no" name="phonepe_no"
                                                           placeholder=""/>
                                                </div>
                                        </div>
										
										<div class="form-group">
                                                <label>Other UPI Number</label>
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"
                                                           class="form-control" required id="otherupi_no" name="otherupi_no"
                                                           placeholder=""/>
                                                </div>
                                        </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <button name="bankdetails" id="bankdetails" class="btn btn-outline-info" type="submit">Submit <i class="far fa-arrow-alt-circle-right"></i></button>	
