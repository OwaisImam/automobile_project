    ...
    <body>
        ...
        <!-- Left Sidebar End -->
            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                         <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="mt-0 header-title">Receivables</h4>
				...
				<p>Add details for sending reminders</p>
					...
					<div class="col-lg-6">
                                <div class="card m-b-30">
                                    ...
                                    <form class="" method="post" action="<?php echo site_url('dealer/receivables')?>">
											...
											<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="number" type="text"
                                                           ...
                                                           placeholder=""  id="contact" name="contact" />
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div>
                                                    <input data-parsley-type="number" type="text"  id="payment_due" name="payment_due" 
                                                           class="form-control" required
                                                           placeholder=""/>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div >
                                                    <input class="form-control" type="date" placeholder=""  id="purchase_date" name="purchase_date" >
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                <label>Remarks</label>
                                                <div>
                                                    <input data-parsley-type="alphanum" type="text"  id="remarks" name="remarks" 
                                                           class="form-control" required
                                                           placeholder=""/>
                                                </div>
                                            </div>
                                            ...
                                            <button name="receivables" id="receivables" class="btn btn-outline-info" type="submit">Submit <i class="far fa-arrow-alt-circle-right"></i></button>	
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
											...
											<table id="datatable-buttons" class="mt-5 table table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                <?php $count=0;
                                                foreach($receivables  as $receivableDetails){  
                                                    $count = $count+1;
                                                    ?> 
                                                <tr>
                                                    <th scope="row"><input type="checkbox" class="selectedId"></th>
                                                    <th><?php echo $count;?></th>
													<td class="text-danger"><?php echo $receivableDetails->remarks;?></td>
                                                    <td><?php echo $receivableDetails->payment_due;?></td>
                                                    <td><?php echo $receivableDetails->name;?></td>
                                                    <td><?php echo $receivableDetails->contact;?></td>
                                                    <td><?php echo $receivableDetails->purchase_date;?></td>
                                                    <td><?php echo $receivableDetails->model;?></td>
                                                    <td><?php echo $receivableDetails->location;?></td>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-body text-center">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <a href="<?php echo site_url('dealer/receivables')."?action=delete&id=".$receivableDetails->id;?>" >
                                        ...
                                        <div class="mt-4 text-center">
											<button type="button" class="btn btn-outline-success waves-effect waves-light mr-3 mb-4 mb-md-0" ><i class="fab fa-whatsapp"></i> Reminder</button>
                                            <button type="button" class="btn btn-outline-warning waves-effect waves-light mr-3 mb-4 mb-md-0" ><i class="fas fa-envelope"></i> Reminder</button>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
