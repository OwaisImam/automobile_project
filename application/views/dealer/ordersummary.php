        ...
        <!-- Left Sidebar End -->
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="mt-0 header-title">Order Summary</h4>
			...
			<div class="row">
				...
				<div class="summary-card">
					<div class="total mb-5">
						...
						<div class="text-right"><a href="<?php echo site_url('dealer/ordersummary')?>" type="submit" class="buy-btn btn btn-secondary waves-effect"><i class="fas fa-shopping-cart" style="padding-right:10px"></i> Buy Now</a></div>
					</div>
					<div class="terms">
			...
			<div class="col-lg-6 mt-5 mt-lg-0 order-2 order-lg-2">
				...
				<div class="summary-card text-center">
				    <p class="mt-5 mb-5">Please Integrate Payment gateway here</p>
				</div>
			</div>
			</div> <!-- end row -->
