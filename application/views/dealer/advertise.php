                    ...
                    <div class="container-fluid">
                         <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="mt-0 header-title">Advertise</h4>
					...
					<div class="col-lg-6">
						...
						<form method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
                                                ...
                                                <input type="file" name="upload_image" class="form-control" required placeholder=""/>
                                            </div>
						
                                            <div class="form-group">
                                                <label>PromoCode</label>
                                                <input type="text" name="promocode" class="form-control" required placeholder=""/>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div>
                                                    <textarea name="products" required class="form-control" rows="5"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div >
                                                <input class="form-control" name="offer_ends_on" type="datetime-local" value="2011-08-19T13:45:00" id="example-datetime-local-input">
                                            </div>
                                            </div>										
							...
							<div class="col-lg-6">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Promotion Image</h4>
										
										<p class="sub-title">Applicable Products : ABC, ABC, XYZ <br> Offer Ends on : 20 Jan 2021 <br> Promo Code : JAN202150</p>
												
                                        <div class="">
                                            <img src="<?php echo base_url();?>assets\images\dealer\small\img-2.jpg" class="img-fluid" alt="Responsive image">
                                        </div>
										
										
                                            <div>
											<h3><a href=""><i class="fas fa-share-alt"></i></a><a style="padding:25px" href=""><i class="fas fa-trash-alt"></i></a></h3>
