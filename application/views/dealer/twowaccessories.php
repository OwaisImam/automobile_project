                    ...
                    <ul class="metismenu" id="side-menu">
                        <li class="menu-title align-items-center">Menu</li>
						 <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="<?php echo site_url('dealer/businessdetails'); ?>"></a></li>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <h4 class="mt-0 header-title">2W Accessories</h4>
									
                                </div>
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-right">
                                        <li class="breadcrumb-item"><a >Product Catalogue</a></li>
                                        <li class="breadcrumb-item active">2W Accessories</li>
										...
										<h4 class="mt-0 text-align-center header-title"><a ><i class="fas fa-plus-circle"></i> | Add Product</a></h4>
					 					<br>
											...
											<div class="form-group">
                                                ...
                                                <input type="file" class="form-control"  name="product_image"  placeholder=""  multiple/>
                                ...
                                <div class="card m-b-30">
                                    ...
                                    <form method="post">
										...
										<div class="form-group">
											...
											<div class="form-group">
                                                <label>Product Image</label>
                                                <?php if(isset($productInfo->product_image)) { if($productInfo->product_image) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="maker" value="<?php if(isset($productInfo->maker)) { echo $productInfo->maker; } ?>"  placeholder="Maker"/>
                                            </div>
											
											<div class="form-group">
                                               
                                                <input type="text" class="form-control" name="applicable_model" value="<?php if(isset($productInfo->applicable_model)) { echo $productInfo->applicable_model; } ?>"  placeholder="Applicable Model(s)"/>
                                            </div>
											<div class="form-group">
                                               
                                                <input type="text" class="form-control" name="category" value="<?php if(isset($productInfo->category)) { echo $productInfo->category; } ?>"  placeholder="Category"/>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="price"  value="<?php if(isset($productInfo->price)) { echo $productInfo->price; } ?>" placeholder="Price"/>
                                            </div>
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <td class="product-logo">
                                                    ...
                                                    <td class="action-btn">
                                                        <ul>
                                                        <li class="mr-2">
                                                                <a href="<?php echo site_url('dealer/twowaccessories')."?action=edit&id=".$productDetails->id;?>" class="edit-btn"><i class="fal fa-edit"></i></a>
                                                            </li>
                                                            <li class="mr-2">
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-body text-center">
                                                                                ...
                                                                                <button type="button" class="btn btn-secondary waves-effect mr-3" data-dismiss="modal">Close</button>
                                                                                    <a href="<?php echo site_url('dealer/twowaccessories')."?action=delete&id=".$productDetails->id;?>" >
