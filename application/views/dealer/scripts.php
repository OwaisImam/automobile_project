...
<link rel="shortcut icon" href="<?php echo base_url();?>assets/images/favicon.ico">
  ...
  <!-- <link rel="shortcut icon" href="<?php echo base_url();?>assets\images\dealer\favicon.ico">
    ...
    <link href="<?php echo base_url();?>assets\css\dealer\style.css" rel="stylesheet" type="text/css">
 -->
  <link href="<?php echo base_url();?>assets\images\dealer\apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <script src="<?php echo base_url();?>assets\js\dealer\main.js"></script>
  <script src="<?php echo base_url();?>assets\js\dealer\font-awesome-5-pro.js"></script>


<script src="<?php echo base_url();?>assets\js\dealer\jquery.min.js"></script>
<script src="<?php echo base_url();?>assets\js\dealer\bootstrap.bundle.min.js"></script>
<script src="<?php echo base_url();?>assets\js\dealer\metismenu.min.js"></script>
<script src="<?php echo base_url();?>assets\js\dealer\jquery.slimscroll.js"></script>
<script src="<?php echo base_url();?>assets\js\dealer\waves.min.js"></script>

<!-- App js -->
<script src="<?php echo base_url();?>assets\js\dealer\app.js"></script>
<!-- Added for profile -->
