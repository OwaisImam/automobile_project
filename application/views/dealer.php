            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
               ...
               <li class="menu-item has-child">
                ...
                <li class="menu-item has-child">
                  <a href="<?php echo site_url('dashboard/useraddress')?>" class="menu-link"><span class="menu-icon oi oi-browser"></span> <span class="menu-text">My Address</span> <span class="badge badge-subtle badge-success"></span></a> <!-- child menu -->  
                </li><!-- /.menu-item -->
              ...
              <!-- section-deck -->
                <div class="section-deck">
                  ...
                  <div class="card card-fluid pb-3">
                    <div class="card-header"> Become a Dealer </div><!-- .lits-group -->
